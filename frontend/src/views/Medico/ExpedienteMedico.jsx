						...
						<section className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
							<article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:p-6">
								<div className="mb-4 flex items-center justify-between gap-3">
									<div>
										...
										<h3 className="text-2xl font-black text-slate-900">Información base del expediente médico</h3>
									</div>
								...
								<div className="grid gap-4 md:grid-cols-2">
									{[
										...
										{ label: 'Diagnóstico base', value: 'Cuadro abdominal en estudio' },
										{ label: 'Ingresó desde', value: 'Admisiones' },
									].map((item) => (
								...
								<div className="mt-4 rounded-2xl border border-[#7E1D3B]/15 bg-[#7E1D3B]/5 p-4">
									<p className="text-xs font-bold uppercase tracking-[0.2em] text-[#7E1D3B]">Enlace entre áreas</p>
									<p className="mt-2 text-sm leading-6 text-slate-700">Este expediente concentra la información que llega desde admisiones y la evolución del área médica, con notas cruzadas para seguimiento interno.</p>
								</div>
							...
							<aside className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:p-6">
								...
								<div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
									...
									<p className="mt-2 text-sm leading-6 text-slate-700">Aquí encaja el circuito médico: historia médica, inventario, evolución, receta y notas de turno sin mezclar información de admisiones con la clínica.</p>
								</div>
							</aside>
						</section>
