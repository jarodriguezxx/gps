...
const PUESTOS_POR_DEPARTAMENTO = {
  'DEPARTAMENTO MÉDICO': ['ENFERMERA (O)', 'NUTRIÓLOGA (O)', 'MÉDICA (O)', 'JEFE DEP. MÉDICO'],
  'DEPARTAMENTO DE ADMISIONES': [
    'ASESOR (A)', 'COMISIONADA (O) TRABAJO SOCIAL', 'RECEPCIONISTA',
    'JEFE DEP. ADMISIONES', 'COMISIONADA (O) TERAPEUTA AMBULATORIO',
  ],
  'DEPARTAMENTO CLÍNICO': [
    'TERAPEUTA DE GRUPO', 'JEFE DEP. CLÍNICO', 'TERAPEUTA ESPIRITUAL',
    'PSICÓMETRA', 'TALLERISTA', 'COTERAPEUTA', 'TERAPEUTA DE CAMPO',
    'ASISTENTE CLÍNICO EXTERNO', 'ASISTENTE CLÍNICO', 'ENCARGADA DE FAMILIA',
    'ENCARGADA (O) POST TRATAMIENTO',
  ],
  'DEPARTAMENTO DE ADMINISTRACIÓN': [
    'JEFE DEP. ADMINISTRACIÓN', 'VELADOR', 'CHOFER', 'ENCARGADO (A) DE COCINA',
    'AUXILIAR DE COCINA', 'AUXILIAR DE MANTENIMIENTO', 'AUXILIAR DE INTENDENCIA',
    'AUXILIAR CONTABLE',
  ],
};
