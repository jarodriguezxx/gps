...
import { Save, X, UserPlus, UserMinus, Tag, ShieldCheck, Eye, EyeOff, CheckCircle, KeyRound, RefreshCw } from 'lucide-react';
...
const ROLES_SISTEMA = [
  'ADMIN', 'RH', 'MÉDICO', 'CLINICO','ADMISIONES', 'FINANCIERO', 'ALMACÉN', 'MATERIALES',
];
